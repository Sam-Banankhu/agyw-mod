<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-dark " style="background-color:  #3c8dbc">
    ...
    <?php // endif; ?>
      <li>
        <a class="nav-link text-white"  href="./" role="button"> <large><b style="color:white;"><?php echo "AGYW"; //$_SESSION['system']['name'] ?></b></large></a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
     ...
     <li class="nav-item dropdown">
            <a class="nav-link"  data-toggle="dropdown" aria-expanded="true" href="javascript:void(0)">
              <span>
                <div class="d-felx badge-pill">
                  ...
                  <span><b style="color:white;"><?php echo ucwords("Pachawo"); //$_SESSION['login_firstname']) ?></b></span>
            ...
            <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
              ...
              <a class="dropdown-item" href="route.php?action=logout"><i class="fa fa-power-off"></i> Logout</a>
            </div>
      </li>
    </ul>
  </nav>
